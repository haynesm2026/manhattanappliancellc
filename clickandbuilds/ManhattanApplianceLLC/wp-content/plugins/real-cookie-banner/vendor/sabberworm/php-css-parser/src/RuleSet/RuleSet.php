 ...
 */
abstract class RuleSet implements
    ...
    public static function parseRuleSet(
        ...
        \DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\RuleSet\RuleSet $oRuleSet
    ) {
        ...
        while (!$oParserState->comes('}')) {
            ...
            if ($oParserState->getSettings()->bLenientParsing) {
                try {
                    $oRule = \DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\Rule\Rule::parse($oParserState);
    ...
    public function addRule(
        \DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\Rule\Rule $oRule,
        \DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\Rule\Rule $oSibling = null
    ) {
        $sRule = $oRule->getRule();
    ...
    public function getRules($mRule = null) {
        if ($mRule instanceof \DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\Rule\Rule) {
            $mRule = $mRule->getRule();
        }
        ...
        \usort($aResult, function (
            \DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\Rule\Rule $first,
            \DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\Rule\Rule $second
        ) {
