 ...
 * Description:  IONOS Assistant will help you complete the first setup of your WordPress in quick and easy steps. It will help you find a theme to start with and add some plugins that will help you with the purpose of your WordPress installation. You can restart it at any time from the admin menu.
 * Version:      7.1.3
...
if ( ! defined( 'IONOS_ASSISTANT_VERSION' ) ) {
	define( 'IONOS_ASSISTANT_VERSION', '7.1.3' );
}
if ( ! defined( 'IONOS_ASSISTANT_BASENAME' ) ) {
	define( 'IONOS_ASSISTANT_BASENAME', plugin_basename( __FILE__ ) );
}
if ( ! defined( 'IONOS_ASSISTANT_SLUG' ) ) {
	define( 'IONOS_ASSISTANT_SLUG', dirname( IONOS_ASSISTANT_BASENAME ) );
}
...
class Ionos_Assistant {
	...
	public function __construct() {
		...
		Ionos_Assistant_Handler_Login::init(
			Ionos\Assistant\Config::get( 'features.login_redesign' )
		);
	...
	public function load_global_files() {
		...
		Ionos\Assistant\Options::set_tenant_and_plugin_name( 'ionos', 'assistant' );
