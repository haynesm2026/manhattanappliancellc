 ...
 */
class Import implements \DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\Property\AtRule {
    /**
     * @var URL
     */
    private $oLocation;
    ...
    public function __construct(
        \DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\Value\URL $oLocation,
        $sMediaQuery,
        $iLineNo = 0
    ) {
