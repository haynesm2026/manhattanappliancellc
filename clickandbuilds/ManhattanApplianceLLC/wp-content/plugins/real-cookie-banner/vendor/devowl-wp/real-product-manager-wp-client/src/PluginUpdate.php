...
use DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\announcement\AnnouncementPool;
use DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\license\PluginUpdateChecker;
use DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\license\PluginUpdateLicensePool;
...
class PluginUpdate {
    ...
    private function __construct($initiator) {
        ...
        $this->view = \DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\view\PluginUpdateView::instance(
            $this
        );
        $this->announcementPool = \DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\announcement\AnnouncementPool::instance(
            $this
        );
        $this->pluginUpdateChecker = \DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\license\PluginUpdateChecker::instance(
            $this
        );
    ...
    protected function getPotentialBlogIds() {
        ...
        if (
            \DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\Utils::isMu() &&
    ...
    public static function instance($initiator) {
        return new \DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\PluginUpdate($initiator);
    }
}
