jQuery(document).ready(function($) {
    'use strict';
    var this_obj = vw_construction_estate_plugin_activate_plugin;
    ...
    $(document).on('click', '.vw-construction-estate-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message vw-construction-estate-plugin-install');
                button.addClass('button-primary vw-construction-estate-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.vw-construction-estate-recommended-plugins .vw-construction-estate-activation-note').css('display','block');
    ...
    $(document).on('click', '.vw-construction-estate-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .vw-construction-estate-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .vw-construction-estate-recommended-plugins').css('display','none');
    });
