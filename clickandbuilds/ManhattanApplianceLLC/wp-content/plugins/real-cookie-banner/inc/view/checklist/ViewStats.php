...
class ViewStats extends \DevOwl\RealCookieBanner\view\checklist\AbstractChecklistItem {
    ...
    public function getDescription() {
        return __(
            'All consents are documented, so that you can prove in doubt who, when and how a consent was given. Statistics about this will help you to e. g. extrapolate Google Analytics data. You can use them to estimate how many visitors have visited your website, even if not all of them have consented to use statistic services.',
            RCB_TD
        );
    }
    // Documented in AbstractChecklistItem
