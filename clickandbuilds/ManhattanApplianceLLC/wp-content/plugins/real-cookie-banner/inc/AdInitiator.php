    ...
    public function getKeyFeatures() {
        return [
            ...
            [
                ...
                'description' => __(
                    'You can design the cookie banner according to your wishes. 20+ design presets and over 200 options give you the flexibility to customize the cookie banner perfectly to fit. From colors and effects to texts, you can let off steam creatively. All changes are shown in a live preview.',
                    RCB_TD
                )
            ],
            [
            ...
            [
                ...
                'description' => __(
                    'Real Cookie Banner is a cookie plugin specially designed for WordPress. It is fully installed in your WordPress as native plugin. All consents are processed and stored on your server. Nothing is downloaded from a cloud in your visitor\'s browser, which avoids further legal issues.',
                    RCB_TD
                )
            ]
        ];
