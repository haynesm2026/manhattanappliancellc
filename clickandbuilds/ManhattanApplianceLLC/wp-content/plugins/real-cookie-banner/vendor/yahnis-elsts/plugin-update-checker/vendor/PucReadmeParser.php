...
if (!\class_exists('DevOwl\\RealCookieBanner\\Vendor\\PucReadmeParser', \false)) {
    /**
    ...
    class PucReadmeParser {
        ...
        function user_sanitize($text, $strict = \false) {
            // whitelisted chars
            if (\function_exists('DevOwl\\RealCookieBanner\\Vendor\\user_sanitize')) {
                // bbPress native
                return \DevOwl\RealCookieBanner\Vendor\user_sanitize($text, $strict);
            }
            if ($strict) {
        ...
        function filter_text($text, $markdown = \false) {
            ...
            if ($markdown) {
                // Parse markdown.
                if (!\class_exists('DevOwl\\RealCookieBanner\\Vendor\\Parsedown', \false)) {
                ...
                $instance = \DevOwl\RealCookieBanner\Vendor\Parsedown::instance();
        ...
        function encodeit($matches) {
            if (\function_exists('DevOwl\\RealCookieBanner\\Vendor\\encodeit')) {
                // bbPress native
                return \DevOwl\RealCookieBanner\Vendor\encodeit($matches);
            }
            $text = \trim($matches[2]);
        ...
        function decodeit($matches) {
            if (\function_exists('DevOwl\\RealCookieBanner\\Vendor\\decodeit')) {
                // bbPress native
                return \DevOwl\RealCookieBanner\Vendor\decodeit($matches);
            }
            $text = $matches[2];
