...
if (!\class_exists('DevOwl\\RealCookieBanner\\Vendor\\Puc_v4p11_Vcs_GitHubApi', \false)) {
    class Puc_v4p11_Vcs_GitHubApi extends \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_Vcs_Api {
        /**
        ...
        public function getLatestRelease() {
            ...
            $reference = new \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_Vcs_Reference([
            ...
            if (!empty($release->body)) {
                ...
                $reference->changelog = \DevOwl\RealCookieBanner\Vendor\Parsedown::instance()->text($release->body);
            }
            return $reference;
        }
        /**
        ...
        public function getLatestTag() {
            ...
            $tag = $versionTags[0];
            return new \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_Vcs_Reference([
                'name' => $tag->name,
