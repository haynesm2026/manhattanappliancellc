...
class OutputFormat {
    ...
    public function __call($sMethodName, array $aArguments) {
        ...
        } elseif (\method_exists(\DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\OutputFormatter::class, $sMethodName)) {
    ...
    public function getFormatter() {
        if ($this->oFormatter === null) {
            $this->oFormatter = new \DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\OutputFormatter($this);
        }
    ...
    public static function create() {
        return new \DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\OutputFormat();
    }
    /**
