...
class Size extends \DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\Value\PrimitiveValue {
    /**
    ...
    public static function parse(
        ...
        return new \DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\Value\Size(
            (float) $sSize,
            $sUnit,
            $bIsColorComponent,
