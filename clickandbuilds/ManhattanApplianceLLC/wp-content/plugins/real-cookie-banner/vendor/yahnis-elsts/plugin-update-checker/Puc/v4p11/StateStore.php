...
if (!\class_exists('DevOwl\\RealCookieBanner\\Vendor\\Puc_v4p11_StateStore', \false)) {
    class Puc_v4p11_StateStore {
         ...
         * @return $this
         */
        public function setUpdate(\DevOwl\RealCookieBanner\Vendor\Puc_v4p11_Update $update = null) {
            $this->lazyLoad();
            $this->update = $update;
            return $this;
        }
        ...
        public function save() {
            ...
            if (isset($this->update)) {
                ...
                if (\DevOwl\RealCookieBanner\Vendor\Puc_v4p11_Utils::startsWith($updateClass, $prefix)) {
        ...
        protected function load() {
            ...
            $this->lastCheck = \intval(\DevOwl\RealCookieBanner\Vendor\Puc_v4p11_Utils::get($state, 'lastCheck', 0));
            $this->checkedVersion = \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_Utils::get($state, 'checkedVersion', '');
            $this->update = null;
