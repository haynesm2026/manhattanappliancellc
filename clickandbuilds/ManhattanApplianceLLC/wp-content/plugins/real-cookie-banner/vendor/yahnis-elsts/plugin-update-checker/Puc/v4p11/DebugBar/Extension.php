...
if (!\class_exists('DevOwl\\RealCookieBanner\\Vendor\\Puc_v4p11_DebugBar_Extension', \false)) {
    class Puc_v4p11_DebugBar_Extension {
        ...
        private function getLibraryUrl($filePath) {
            ...
            $absolutePath = \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_Factory::normalizePath($absolutePath);
            $pluginDir = \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_Factory::normalizePath(\WP_PLUGIN_DIR);
            $muPluginDir = \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_Factory::normalizePath(\WPMU_PLUGIN_DIR);
            $themeDir = \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_Factory::normalizePath(\get_theme_root());
