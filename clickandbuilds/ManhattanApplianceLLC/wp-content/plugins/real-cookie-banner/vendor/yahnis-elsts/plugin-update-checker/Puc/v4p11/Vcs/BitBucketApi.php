...
if (!\class_exists('DevOwl\\RealCookieBanner\\Vendor\\Puc_v4p11_Vcs_BitBucketApi', \false)) {
    class Puc_v4p11_Vcs_BitBucketApi extends \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_Vcs_Api {
        /**
        ...
        public function api($url, $version = '2.0') {
            $url = \ltrim($url, '/');
            $isSrcResource = \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_Utils::startsWith($url, 'src/');
            $url = \implode('/', [
        ...
        public function setAuthentication($credentials) {
            ...
            if (!empty($credentials) && !empty($credentials['consumer_key'])) {
                $this->oauth = new \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_OAuthSignature(
