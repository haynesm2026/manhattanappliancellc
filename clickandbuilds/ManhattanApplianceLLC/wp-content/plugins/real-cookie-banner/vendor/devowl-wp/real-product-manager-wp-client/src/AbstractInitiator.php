...
abstract class AbstractInitiator {
    ...
    public function getPluginUpdater() {
        if ($this->pluginUpdate === null) {
            $this->pluginUpdate = \DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\PluginUpdate::instance(
                $this
            );
        }
    ...
    public function start() {
        \DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\Core::getInstance()->addInitiator($this);
    }
    // Self-explaining
