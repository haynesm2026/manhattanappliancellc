...
class Core {
    ...
    private function __construct() {
        $this->ratingHandler = \DevOwl\RealCookieBanner\Vendor\DevOwl\RealUtils\RatingHandler::instance($this);
        $this->crossSellingHandler = \DevOwl\RealCookieBanner\Vendor\DevOwl\RealUtils\cross\CrossSellingHandler::instance(
            $this
        );
        $this->assets = \DevOwl\RealCookieBanner\Vendor\DevOwl\RealUtils\Assets::instance();
        \DevOwl\RealCookieBanner\Vendor\DevOwl\RealUtils\view\Options::instance();
        add_action('rest_api_init', [
            \DevOwl\RealCookieBanner\Vendor\DevOwl\RealUtils\Service::instance(),
            'rest_api_init'
        ]);
        ...
        $this->crossSelling[
            \DevOwl\RealCookieBanner\Vendor\DevOwl\RealUtils\cross\CrossRealCookieBanner::SLUG
        ] = new \DevOwl\RealCookieBanner\Vendor\DevOwl\RealUtils\cross\CrossRealCookieBanner();
        $this->crossSelling[
            \DevOwl\RealCookieBanner\Vendor\DevOwl\RealUtils\cross\CrossRealMediaLibrary::SLUG
        ] = new \DevOwl\RealCookieBanner\Vendor\DevOwl\RealUtils\cross\CrossRealMediaLibrary();
        $this->crossSelling[
            \DevOwl\RealCookieBanner\Vendor\DevOwl\RealUtils\cross\CrossRealCategoryLibrary::SLUG
        ] = new \DevOwl\RealCookieBanner\Vendor\DevOwl\RealUtils\cross\CrossRealCategoryLibrary();
        $this->crossSelling[
            \DevOwl\RealCookieBanner\Vendor\DevOwl\RealUtils\cross\CrossRealPhysicalMedia::SLUG
        ] = new \DevOwl\RealCookieBanner\Vendor\DevOwl\RealUtils\cross\CrossRealPhysicalMedia();
    }
    /**
     * Add an initiator.
     *
    ...
    public static function getInstance() {
        return !isset(self::$me)
            ? (self::$me = new \DevOwl\RealCookieBanner\Vendor\DevOwl\RealUtils\Core())
            : self::$me;
    }
}
