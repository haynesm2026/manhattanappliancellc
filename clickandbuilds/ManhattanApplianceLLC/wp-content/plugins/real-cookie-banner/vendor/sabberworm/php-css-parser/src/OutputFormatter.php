...
class OutputFormatter {
     ...
     */
    private $oFormat;
    public function __construct(\DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\OutputFormat $oFormat) {
    ...
    public function safely($cCode) {
        if ($this->oFormat->get('IgnoreExceptions')) {
            ...
            try {
                return $cCode();
            } catch (\DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\Parsing\OutputException $e) {
                return null;
            }
            // Do nothing
        } else {
    ...
    public function implode($sSeparator, array $aValues, $bIncreaseLevel = \false) {
        ...
        foreach ($aValues as $mValue) {
            ...
            if ($mValue instanceof \DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\Renderable) {
