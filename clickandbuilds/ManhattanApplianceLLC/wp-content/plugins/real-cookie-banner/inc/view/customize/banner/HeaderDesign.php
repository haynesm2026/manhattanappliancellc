...
class HeaderDesign {
    use UtilsProvider;
    const SECTION = \DevOwl\RealCookieBanner\view\BannerCustomize::PANEL_MAIN . '-header-design';
        ...
        return [
            ...
            'controls' => [
                ...
                self::HEADLINE_LOGO => [
                    ...
                    'label' => __('Logo', RCB_TD)
                ],
                self::SETTING_LOGO => [
                    'class' => \WP_Customize_Image_Control::class,
                    'name' => 'logo',
                    'label' => __('Image', RCB_TD),
                    'description' => __(
                        'The recommended minimum height of your logo is <strong>128px</strong>. The width of your logo will be adjusted automatically.',
                        RCB_TD
                    )
                ],
                self::SETTING_LOGO_RETINA => [
                    'class' => \WP_Customize_Image_Control::class,
                    'name' => 'logoRetina',
                    'label' => __('Image (x2 for Retina)', RCB_TD)
                ],
                ...
                self::SETTING_LOGO_POSITION => [
                    'name' => 'logoPosition',
                    'label' => __('Alignment relative to headline', RCB_TD),
                    'type' => 'select',
                    'choices' => [
                        'left' => __('Left', RCB_TD),
                        'right' => __('Right', RCB_TD),
                        'above' => __('Above', RCB_TD)
                    ],
                    'setting' => ['default' => self::DEFAULT_LOGO_POSITION]
                ],
                self::SETTING_LOGO_MARGIN => [
                    'class' => \DevOwl\RealCookieBanner\Vendor\DevOwl\Customize\controls\CssMarginInput::class,
                    'name' => 'logoMargin',
                    'label' => __('Margin', RCB_TD),
                    'description' => __('Define the outer distance around the logo.', RCB_TD),
                    'setting' => ['default' => self::DEFAULT_LOGO_MARGIN]
                ],
                self::HEADLINE_FONT => [
                    'class' => \DevOwl\RealCookieBanner\Vendor\DevOwl\Customize\controls\Headline::class,
                ...
                self::SETTING_FONT_INHERIT_FAMILY => [
                    ...
                    'label' => __('Inherit font family', RCB_TD),
                    'type' => 'checkbox',
                    'setting' => [
                ...
                self::HEADLINE_BORDER_BOTTOM => [
                    'class' => \DevOwl\RealCookieBanner\Vendor\DevOwl\Customize\controls\Headline::class,
                    'label' => __('Bottom border', RCB_TD),
                    'description' => __(
                        'You can define an additional bottom border to separate the header from the body.',
                        RCB_TD
                    )
                ],
                ...
                self::SETTING_BOTTOM_BORDER_COLOR => [
                    ...
                    'label' => __('Color', RCB_TD),
                    'setting' => [
                        'default' => self::DEFAULT_BOTTOM_BORDER_COLOR,
