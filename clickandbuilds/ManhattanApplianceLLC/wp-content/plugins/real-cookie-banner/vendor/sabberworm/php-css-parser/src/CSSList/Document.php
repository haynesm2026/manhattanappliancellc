 ...
 */
class Document extends \DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\CSSList\CSSBlockList {
    /**
     * @param int $iLineNo
     */
    ...
    public static function parse(\DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\Parsing\ParserState $oParserState) {
        $oDocument = new \DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\CSSList\Document($oParserState->currentLine());
        \DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\CSSList\CSSList::parseList($oParserState, $oDocument);
        return $oDocument;
    }
    /**
     ...
     * @return string
     */
    public function render(\DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\OutputFormat $oOutputFormat = null) {
        if ($oOutputFormat === null) {
            $oOutputFormat = new \DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\OutputFormat();
        }
