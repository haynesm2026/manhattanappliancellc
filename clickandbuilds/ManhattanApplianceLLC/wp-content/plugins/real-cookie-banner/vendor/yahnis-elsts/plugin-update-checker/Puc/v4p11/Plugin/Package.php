...
if (!\class_exists('DevOwl\\RealCookieBanner\\Vendor\\Puc_v4p11_Plugin_Package', \false)) {
    class Puc_v4p11_Plugin_Package extends \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_InstalledPackage {
        /**
        ...
        public function isMuPlugin() {
            ...
            if ($cachedResult === null) {
                ...
                if ($muPluginDir === \false || $pluginPath === \false) {
                    ...
                    $pluginPath = \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_Factory::normalizePath(
