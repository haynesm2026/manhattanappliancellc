...
if (!\class_exists('DevOwl\\RealCookieBanner\\Vendor\\Puc_v4p11_Vcs_Api')) {
    abstract class Puc_v4p11_Vcs_Api {
        ...
        public function getRemoteReadme($ref = 'master') {
            ...
            $parser = new \DevOwl\RealCookieBanner\Vendor\PucReadmeParser();
        ...
        public function getRemoteChangelog($ref, $localDirectory) {
            ...
            return \DevOwl\RealCookieBanner\Vendor\Parsedown::instance()->text($changelog);
        }
        /**
