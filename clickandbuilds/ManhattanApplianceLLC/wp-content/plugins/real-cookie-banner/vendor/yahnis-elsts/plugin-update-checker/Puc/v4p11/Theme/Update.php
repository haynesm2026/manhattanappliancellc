...
if (!\class_exists('DevOwl\\RealCookieBanner\\Vendor\\Puc_v4p11_Theme_Update', \false)) {
    class Puc_v4p11_Theme_Update extends \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_Update {
        public $details_url = '';
