...
abstract class AbstractInitiator {
    ...
    public function start() {
        \DevOwl\RealCookieBanner\Vendor\DevOwl\RealUtils\Core::getInstance()->addInitiator($this);
        $this->welcomePage = \DevOwl\RealCookieBanner\Vendor\DevOwl\RealUtils\WelcomePage::instance($this);
