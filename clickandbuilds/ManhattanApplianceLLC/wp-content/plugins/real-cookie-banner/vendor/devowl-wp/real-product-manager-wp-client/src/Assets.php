...
class Assets {
    ...
    public function overrideLocalizeScript($context) {
        ...
        $names = [];
        foreach (
            \DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\Core::getInstance()->getInitiators()
            as $initiator
        ) {
    ...
    public static function instance() {
        return new \DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\Assets();
    }
}
