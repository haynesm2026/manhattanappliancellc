...
abstract class ValueList extends \DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\Value\Value {
    /**
    ...
    public function render(\DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\OutputFormat $oOutputFormat) {
        return $oOutputFormat->implode(
            $oOutputFormat->spaceBeforeListArgumentSeparator($this->sSeparator) .
                $this->sSeparator .
