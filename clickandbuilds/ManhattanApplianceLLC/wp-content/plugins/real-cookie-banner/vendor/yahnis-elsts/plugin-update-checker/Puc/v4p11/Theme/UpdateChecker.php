...
if (!\class_exists('DevOwl\\RealCookieBanner\\Vendor\\Puc_v4p11_Theme_UpdateChecker', \false)) {
    class Puc_v4p11_Theme_UpdateChecker extends \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_UpdateChecker {
        ...
        protected function createScheduler($checkPeriod) {
            return new \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_Scheduler($this, $checkPeriod, ['load-themes.php']);
        }
        /**
        ...
        protected function createDebugBarExtension() {
            return new \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_DebugBar_Extension(
                $this,
        ...
        protected function createInstalledPackage() {
            return new \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_Theme_Package($this->stylesheet, $this);
        }
    }
}
