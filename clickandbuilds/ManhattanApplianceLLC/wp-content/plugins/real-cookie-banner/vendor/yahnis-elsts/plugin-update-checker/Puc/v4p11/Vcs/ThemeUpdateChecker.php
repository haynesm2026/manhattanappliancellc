...
if (!\class_exists('DevOwl\\RealCookieBanner\\Vendor\\Puc_v4p11_Vcs_ThemeUpdateChecker', \false)) {
    class Puc_v4p11_Vcs_ThemeUpdateChecker
        extends \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_Theme_UpdateChecker
        implements \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_Vcs_BaseChecker {
        /**
        ...
        public function requestUpdate() {
            ...
            $update = new \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_Theme_Update();
            ...
            $update->version = \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_Utils::findNotEmpty([
                $remoteHeader['Version'],
                \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_Utils::get($updateSource, 'version')
            ]);
            //The details URL defaults to the Theme URI header or the repository URL.
            $update->details_url = \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_Utils::findNotEmpty([
