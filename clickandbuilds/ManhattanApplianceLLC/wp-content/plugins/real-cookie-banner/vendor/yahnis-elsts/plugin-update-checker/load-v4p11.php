...
new \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_Autoloader();
...
foreach (
    ...
    \DevOwl\RealCookieBanner\Vendor\Puc_v4_Factory::addVersion($pucGeneralClass, $pucVersionedClass, '4.11');
    //Also add it to the minor-version factory in case the major-version factory
    //was already defined by another, older version of the update checker.
    \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_Factory::addVersion($pucGeneralClass, $pucVersionedClass, '4.11');
}
