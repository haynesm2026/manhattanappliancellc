...
if (!\class_exists('DevOwl\\RealCookieBanner\\Vendor\\Puc_v4p11_Plugin_Update', \false)) {
    /**
     ...
     * @access public
     */
    class Puc_v4p11_Plugin_Update extends \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_Update {
        public $id = 0;
        public $homepage;
        ...
        public static function fromJson($json) {
            ...
            $pluginInfo = \DevOwl\RealCookieBanner\Vendor\Puc_v4p11_Plugin_Info::fromJson($json);
            if ($pluginInfo !== null) {
