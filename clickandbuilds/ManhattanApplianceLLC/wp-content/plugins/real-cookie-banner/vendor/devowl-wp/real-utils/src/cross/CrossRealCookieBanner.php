...
namespace DevOwl\RealCookieBanner\Vendor\DevOwl\RealUtils\cross;
 ...
 */
class CrossRealCookieBanner extends \DevOwl\RealCookieBanner\Vendor\DevOwl\RealUtils\cross\AbstractCrossSelling {
    ...
    public function skip() {
        ...
        $handler = \DevOwl\RealCookieBanner\Vendor\DevOwl\RealUtils\Core::getInstance()->getCrossSellingHandler();
    ...
    public function hasGdprPluginInstalled($plugins) {
        foreach ($plugins as $slug) {
            $file = \DevOwl\RealCookieBanner\Vendor\DevOwl\RealUtils\Core::getInstance()
