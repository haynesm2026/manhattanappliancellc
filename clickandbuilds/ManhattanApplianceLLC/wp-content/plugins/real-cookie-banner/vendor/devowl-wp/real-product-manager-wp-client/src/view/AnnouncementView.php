...
namespace DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\view;

use DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\announcement\Announcement;
...
class AnnouncementView {
    ...
    public static function instance($pool) {
        return new \DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\view\AnnouncementView($pool);
    }
}
